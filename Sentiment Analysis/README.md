...
- Standardizing Text: All text was converted to lowercase to ensure uniformity. - Removing Unnecessary Elements: Special characters, links, and numbers were removed 
...
## 2. Data Analysis:
- Review Length Analysis: new column representing the length of each review was 
...
- I applied TfidfVectorizer to transform text into numerical features based on the 
...
- Data Splitting: I used train_test_split to split the data into 80% training and 20% 
